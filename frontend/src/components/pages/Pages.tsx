...
const Pages: React.FC<{
  path: string, pageNumber: number, setPageNumber:React.Dispatch<React.SetStateAction<number>>, numberOfPages: number
}> = ({
  path, pageNumber, setPageNumber, numberOfPages
}) => {
