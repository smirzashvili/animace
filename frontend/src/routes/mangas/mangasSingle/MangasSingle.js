...
const MangasSingle = ({ darkMode, darkStyleHome }) => {
    ...
    useEffect(() => {
        const getMangaInfo = async () => {
            const res = await mangasApi.fetchManga(name)
            if(res.data) {
    ...
    const {mangaInfo} = useSelector(state=>state.MangasReducer)
  ...
  return (
    <div className={styles.parentGrid}>
        <div className={styles.parentGridItem}>
            <Rating rating={mangaInfo.rating}/>
            ...
            <div className={styles.grid}>
                ...
                <div className={styles.gridItem}>
                    ...
                    <div style={darkMode ? darkStyleHome : {}} className={styles.ratingEntries}>
                        ...
                        {reviews?.filter(item => item.about === mangaInfo.title).length > 0 ?
                        reviews?.filter(item => item.about === mangaInfo.title).map(item1 => {
                            return (
                                <>
